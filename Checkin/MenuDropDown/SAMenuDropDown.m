...
- (void)uiSetUp
{
    ...
    _tableMenu.backgroundColor = [UIColor colorWithRed:245.0/255.0 green:245.0/255.0 blue:245.0/255.0 alpha:1];
   // _tableMenu.separatorStyle = UITableViewCellSeparatorStyleNone;
    _tableMenu.separatorColor = [UIColor grayColor];
    
    
    _tableMenu.frame = CGRectMake(0, 0, _sourceButtom.frame.size.width+30, 0);
    ...
    [UIView animateWithDuration:0.5
                     animations:^{
                      ...
                      //   self.frame = vFrame;
                         ...
                         self.frame = CGRectMake(vFrame.origin.x-30, vFrame.origin.y+5, vFrame.size.width+30, vFrame.size.height);

                         _tableMenu.frame = CGRectMake(0, 0, _sourceButtom.frame.size.width+30, _menuHeight);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.row == 0)
    {
        cell.backgroundColor=[UIColor colorWithRed:1.0/255.0 green:156.0/255.0 blue:220.0/255.0 alpha:1];
    }
    
    cell.detailTextLabel.font = [UIFont systemFontOfSize:12.0];
    cell.detailTextLabel.textColor = [UIColor colorWithRed:245.0/255.0 green:245.0/255.0 blue:245.0/255.0 alpha:1];
